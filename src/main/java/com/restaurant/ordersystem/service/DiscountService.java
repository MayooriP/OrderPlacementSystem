...
public class DiscountService {
    ...
    public BigDecimal calculateCouponDiscount(Coupon coupon, BigDecimal totalPrice) {
        if (coupon == null) {
        ...
        if (totalPrice.compareTo(BigDecimal.valueOf(coupon.getMinOrderValue())) < 0) {
            throw new InvalidCouponException("Order total does not meet the minimum amount required for this coupon");
        }
